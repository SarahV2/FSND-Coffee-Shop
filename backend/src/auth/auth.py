...
AUTH0_DOMAIN = "udacity-cool-coffeeshop.us.auth0.com"
ALGORITHMS = ["RS256"]
API_AUDIENCE = "drinks"
...
def get_token_auth_header():
    ...
    if auth_string[0].lower() != "bearer":
        ...
        raise AuthError({"code": "invalid header",
                         "description": "Not a valid bearer token"}, 401)
    token = auth_string[1]
    print(token)
    return token
...
@(Done) implement verify_decode_jwt(token) method
    ...
    !!NOTE urlopen has a common certificate
    error described here: https://stackoverflow.com/questions/50236117/
